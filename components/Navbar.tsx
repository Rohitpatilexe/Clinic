          ...
          <div className="flex items-center gap-4 md:gap-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-primary hover:bg-teal-700 text-white px-5 py-2.5 rounded-full font-bold shadow-md hover:shadow-lg transition-all active:scale-95"
              >
