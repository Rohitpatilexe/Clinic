        ...
        return (
            <div ref={ref} className="bg-white text-slate-900 p-8 max-w-[210mm] mx-auto min-h-[297mm] relative font-sans">
                ...
                <div className="border-b-2 border-slate-900 pb-6 mb-8 flex justify-between items-start">
                    <div>
                        <h1 className="text-4xl font-bold text-teal-700 mb-2">JOINTCARE</h1>
                        <p className="text-sm text-slate-600 max-w-sm">NMR Scan Center, Gokul Rd, opposite New Bus Stand, Industrial Estate, Hubballi, Karnataka 580030</p>
                        <p className="text-sm text-slate-600 font-semibold mt-1">Phone: +91 81339 05968</p>
                    </div>
                    <div className="text-right">
                        ...
                        <p className="text-xs text-slate-500">Reg No: KMC 118015</p>
                ...
                <div className="border border-slate-300 rounded-lg p-4 mb-8 bg-slate-50 flex flex-wrap gap-y-4 justify-between items-center text-sm">
                    ...
                    <div className="w-1/4">
                        ...
                        <span className="font-bold text-slate-700 ml-4">Gender:</span>
                        <span className="ml-2">{patient.gender || 'N/A'}</span>
                    </div>
                    <div className="w-1/4 text-right">
                        <span className="font-bold text-slate-700">Date:</span>
                        <span className="ml-2">{new Date(patient.date).toLocaleDateString()}</span>
                    </div>
                ...
                <div className="absolute bottom-12 left-8 right-8 border-t border-slate-200 pt-8 flex justify-between items-end">
                    <div>
                        ...
                        <p className="text-2xl text-teal-700 font-bold mt-1">+91 81339 05968</p>
                    </div>
